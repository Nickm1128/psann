...
This is a "regular transformer" (LayerNorm + GELU MLP) baseline to compare
against the PSANN-based variants in this repo. It reuses the same attention
implementation (including RoPE/ALiBi support) for apples-to-apples throughput
and perplexity comparisons.
"""
