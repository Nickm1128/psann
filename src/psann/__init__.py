...
_LAZY_ATTRS = {
    ...
    # Expanders / activation configs
    "LSM": ".preprocessing",
    "LSMExpander": ".preprocessing",
    "LSMConv2d": ".preprocessing",
    "LSMConv2dExpander": ".preprocessing",
    "LSMConfig": ".preprocessing",
    "LSMPretrainingConfig": ".preprocessing",
    "ModulePreprocessorConfig": ".preprocessing",
    "PreprocessorConfig": ".preprocessing",
    "PreprocessorTrainingConfig": ".preprocessing",
