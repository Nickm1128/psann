...
- After results sync back, refresh `README.md`, `docs/PSANN_Results_Compendium.md`, WaveResNet notebooks, and other GPU sections with the captured metrics and logging workflow notes.
